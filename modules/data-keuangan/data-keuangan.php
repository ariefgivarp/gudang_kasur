...
<head>
        ...
        <title>Gudang Kasur | Data Keuangan</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-folder"> Data Keuangan</h2>
                <button class="dropbtn"><a href="data-keuangan-tambah.php" class="fa fa-plus"> Tambah Data</a></button>
                <table id="tabel-data">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <?php 
                        ...
                        $no= 1;
                        $data = mysqli_query($koneksi,"SELECT * FROM gk_data_keuangan ORDER BY id DESC");
                        while($d = mysqli_fetch_array($data)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $d['kode_uang']; ?></td>
                                <td><?php echo $d['keterangan']; ?></td>
                                <td><label>Rp. </label><?php echo $nominal; ?></td>
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="edit" href="data-keuangan-edit.php?id=<?php echo $d['id']; ?>"><span class="fa fa-pencil-square"></span></a>
                                    
                                    <a data-toggle="tooltip" data-placement="top" title="Hapus" href="data-keuangan-hapus.php?=<?php echo $d['id']; ?>"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                            <?php 
                        }
