...
<head>
        ...
        <title>Gudang Kasur | Ubah Data Keuangan</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title">Ubah Data Keuangan</h2>
                <button class="dropbtn"><a href="data-keuangan.php" class="fa fa-undo"> Kembali</a></button>
                <form action="data-keuangan-edit-aksi.php" method="POST">
                    <?php
                    include './../../config/koneksi.php';
                    require_once './../../config/fungsi_rupiah.php';

                    if (isset($_GET['id'])) {
                        $query = mysqli_query($koneksi,"select * from gk_data_keuangan where id='$_GET[id]'") 
                                                        or die('Ada kesalahan pada query tampil Data  : '.mysqli_error($mysqli));
                        $d  = mysqli_fetch_assoc($query);
                      }
                        ?>
                        <form method="post" action="data-keuangan-edit-aksi.php">
                        <table>
                        <tr>
                            <td>Kode Transaksi</td>
                            <td><input type="text" name="kode_uang" required="required" value="<?php echo $d['kode_uang']; ?>" readonly></td>
                        </tr>
                        <tr>
                            <td>Keterangan</td>
                        ...
                        <tr>
                            ...
                            <input type="numeric" class="form-control" id="nominal" name="nominal" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo format_rupiah($d['nominal']); ?>" required></td>
                        </tr>
                    </table>
