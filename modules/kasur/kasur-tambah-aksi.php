...
if(isset($_POST['submit'])){
    ...
    $harga_awal = str_replace('.', '', mysqli_real_escape_string($mysqli, trim($_POST['harga_awal'])));
    ...
    // buat query
    $sql = "insert into gk_kasur values('', NOW(), '$kode_kasur', '$nama_kasur', '$tipe_busa', '$ukuran_kasur', '$densiti_kasur', '$harga_awal', '$harga_jual', '$satuan', '')";
    ...
    if( $query ) {
        ...
        header('Location: kasur-tambah.php?status=gagal');
    }
