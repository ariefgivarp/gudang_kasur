...
<head>
        ...
        <title>Gudang Kasur | Data Kasur</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-folder"> Data Kasur</h2>
                <button class="dropbtn"><a href="kasur-tambah.php" class="fa fa-plus"> Tambah Data</a></button>
                <table id="tabel-data">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <?php 
                        ...
                        $no= 1;
                        $data = mysqli_query($koneksi,"SELECT * FROM gk_kasur ORDER BY id_kasur DESC");
                        while($d = mysqli_fetch_array($data)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="edit" href="kasur-edit.php?id_kasur=<?php echo $d['id_kasur']; ?>"><span class="fa fa-pencil-square"></span></a>
                                    
                                    <a data-toggle="tooltip" data-placement="top" title="Hapus" href="kasur-hapus.php?id_kasur=<?php echo $d['id_kasur']; ?>"><span class="fa fa-trash"></span></a>
                                </td>
                            </tr>
                            <?php 
                        }
