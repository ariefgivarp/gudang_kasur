...
<head>
        ...
        <title>Gudang Kasur | Tambah Data Kasur</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title">Tambah Data Kasur</h2>
                <button class="dropbtn"><a href="kasur.php" class="fa fa-undo"> Kembali</a></button>

                <form method="post" action="kasur-tambah-aksi.php">
                    <?php  
                        include './../../config/koneksi.php';
                        require_once './../../config/fungsi_rupiah.php';

                        $query = mysqli_query($koneksi, "SELECT max(kode_kasur) as kodeTerbesar FROM gk_kasur");
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><span class="input-group-addon">Rp.</span>
                                <input type="numeric" class="form-control" id="harga_awal" name="harga_awal" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required></td>
                        </tr>
                        <tr>
                            <td>Harga Jual</td>
                            <td><span class="input-group-addon">Rp.</span>
