...
if(isset($_POST['simpan'])){
    // ambil data dari formulir
        ...
        $harga_awal = str_replace('.', '', mysqli_real_escape_string($koneksi, trim($_POST['harga_awal'])));
        ...
        // buat query update
        $sql = "UPDATE gk_kasur SET nama_kasur='$nama_kasur', tipe_busa='$tipe_busa', ukuran_kasur='$ukuran_kasur', densiti_kasur='$densiti_kasur', harga_awal='$harga_awal', harga_jual='$harga_jual', satuan='$satuan' WHERE kode_kasur = '$kode_kasur'";
