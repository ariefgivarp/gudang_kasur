...
<head>
        ...
        <title>Gudang Kasur | Ubah Data Pesanan</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title">Ubah Data Pesanan</h2>
                ...
                <form action="pesanan-edit-aksi.php" method="POST">
                    ...
                    if (isset($_GET['id_kasur'])) {
                        $query = mysqli_query($koneksi,"select * from gk_pesanan where id_kasur='$_GET[id_kasur]'") 
                        ...
                        <tr>
                        <td>Nama Pembeli</td>
                            <td><input type="text" name="nama_pembeli" value="<?php echo $d['nama_pembeli']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Harga Jual</td>
