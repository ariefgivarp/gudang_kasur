...
<head>
        ...
        <title>Gudang Kasur | Data Kasur Keluar</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-sign-out"> Data Kasur Keluar</h2>
                <table id="tabel-data">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <?php 
                        ...
                        $no= 1;
                        $data = mysqli_query($koneksi,"SELECT * FROM gk_kasur_keluar ORDER BY id DESC");
                        while($d = mysqli_fetch_array($data)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="edit" href="kasur-keluar-edit.php?id=<?php echo $d['id']; ?>"><span class="fa fa-pencil-square"></span></a>
                                </td>
                            </tr>
                            <?php 
                        }
                ...
                <form action="kasur-keluar-aksi.php" method="POST">
                    <?php
                        $query = mysqli_query($koneksi, "SELECT max(kode_transaksi) as kodeTerbesar FROM gk_kasur_keluar");
                    ...
                    <table width="530" border="0">
                        ...
                        <tr>
                            <td>Nama Pembeli</td>
                            <td><input type="text" name="nama_pembeli" maxlength="11" required /></td>
                        </tr>
                        <tr>
