...
<header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-clone"> Laporan Kasur Keluar</h2>

                <form method="get" action="lap-keluar.php">
                    <div class="row">
                    ...
                    if(isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                        echo '<a href="lap-keluar.php" class="btn btn-default">RESET</a>';
                    ?>
                </form>
