...
<head>
        ...
        <title>Gudang Kasur | Data Kasur Masuk</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-sign-in"> Data Kasur Masuk</h2>
                <table id="tabel-data">
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <?php 
                        ...
                        $no= 1;
                        $data = mysqli_query($koneksi,"SELECT * FROM gk_kasur_masuk ORDER BY id DESC");
                ...
                <h2 class="section-title"><span class="fa fa-sign-in"> Form Kasur Masuk</h2>
                <form action="kasur-masuk-tambah-aksi.php" method="POST">
                    <?php
                        $query = mysqli_query($koneksi, "SELECT max(kode_transaksi) as kodeTerbesar FROM gk_kasur_masuk");
                    ...
                    <table width="530" border="0">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="tanggal_masuk" value="<?php echo date("d-m-Y"); ?>" readonly required></td>
                        </tr>
                            <td>Pilih Barang</td>
                            <td>
                                <?php
                                $selBar	=mysqli_query($koneksi, "SELECT * FROM gk_kasur ORDER BY kode_kasur");        
                        ...
                        <tr>
                            <td>Jumlah</td>
                            <td><input type="text" name="jumlah_masuk" maxlength="11" required /></td>
                        </tr>
                        <tr height="36">
                            <td></td>
