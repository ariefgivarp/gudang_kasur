...
<head>
        ...
        <title>Gudang Kasur | Ubah Status Pesanan</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title">Ubah Status Pesanan</h2>
                <button class="dropbtn"><a href="pesanan-keluar.php" class="fa fa-undo"> Kembali</a></button>
                <form action="pesanan-edit-aksi.php" method="POST">
                    <?php
                    include './../../config/koneksi.php';
                    require_once './../../config/fungsi_rupiah.php';

                    if (isset($_GET['id'])) {
                        $query = mysqli_query($koneksi,"select * from gk_pesanan_keluar where id='$_GET[id]'") 
                                                        or die('Ada kesalahan pada query tampil Data  : '.mysqli_error($mysqli));
                        $d  = mysqli_fetch_assoc($query);
                      }
                        ?>
                        <form method="post" action="pesanan-edit-aksi.php">
                        <table>
                        <tr>
