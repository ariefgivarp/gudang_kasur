...
<header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-clone"> Laporan Kasur Masuk</h2>

                <form method="get" action="lap-masuk.php">
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tgl_akhir" value="<?= @$_GET['tgl_akhir'] ?>"  placeholder="Tanggal Akhir" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if(isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                        echo '<a href="lap-masuk.php" class="btn btn-default">RESET</a>';
                    ?>
                </form>
