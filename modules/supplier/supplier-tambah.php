...
<head>
        ...
        <title>Gudang Kasur | Tambah Data Supplier</title>
    ...
    <header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title">Tambah Data Supplier</h2>
                <button class="dropbtn"><a href="supplier.php" class="fa fa-undo"> Kembali</a></button>

                <form method="post" action="supplier-tambah-aksi.php">
                    <?php  
                        include './../../config/koneksi.php';
                        require_once './../../config/fungsi_rupiah.php';

                        $query = mysqli_query($koneksi, "SELECT max(kode_supplier) as kodeTerbesar FROM gk_supplier");
                    ...
                    <table>
                        <tr>
                            <td>Kode Supplier</td>
                            <td><input type="text" name="kode_supplier" required="required" value="<?php echo $kodeBarang ?>" readonly></td>
                        </tr>
                        <tr>
                            <td>Nama Supplier</td>
                        ...
                        <tr>
                            <td>Alamat</td>
                            <td><input type="textarea" name="alamat_supplier" rows="4" cols="50"></td>
                        </tr>
                        <tr>
                            <td>No Telp</td>
                            <td><input type="text" name="cp_supplier"></td>
                        </tr>
                        <tr>
                            <td>Harga Barang</td>
                            <td><span class="input-group-addon">Rp.</span>
                                <input type="numeric" class="form-control" id="harga_supplier" name="harga_supplier" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required></td>
                        </tr>
                    </table>
