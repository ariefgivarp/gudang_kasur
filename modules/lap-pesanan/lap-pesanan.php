...
<header>
        ...
        <div class="contact-form">
            <div class="container">
                <h2 class="section-title"><span class="fa fa-clone"> Laporan Pesanan Keluar</h2>

                <form method="get" action="lap-pesanan.php">
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                <label>Filter Tanggal</label>
                                <div class="input-group">
                                    <input type="date" name="tgl_awal"   placeholder="Tanggal Awal" autocomplete="off">
                                    <span class="input-group-addon">s/d</span>
                                    <input type="date" name="tgl_akhir"   placeholder="Tanggal Akhir" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if(isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                        echo '<a href="lap-pesanan.php" class="btn btn-default">RESET</a>';
                    ?>
                </form>
                ...
                if(empty($tgl_awal) or empty($tgl_akhir)){ // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                    ...
                    $query = "SELECT * FROM gk_pesanan_keluar";
                    $url_cetak = "cetak.php";
                    $label = "Semua Data Transaksi";
                }else{ // Jika terisi
                    // Buat query untuk menampilkan data transaksi sesuai periode tanggal
                    $query = "SELECT * FROM gk_pesanan_keluar WHERE (tanggal_keluar BETWEEN '".$tgl_awal."' AND '".$tgl_akhir."')";
